...
namespace FluentAdb.Interfaces
{
    ...
    {
        /// <summary>
        /// Start an Activity specified by <paramref name="intent"/>
        /// </summary>
        ...
        /// <summary>
        /// Start the Service specified by <paramref name="intent"/>.
        /// </summary>
        ...
        /// <summary>
        /// Force stop everything associated with <paramref name="package"/>
        /// </summary>
        ...
        /// <summary>
        /// Kill all processes associated with <paramref name="package"/>. This command kills only processes that are safe to kill and that will not impact the user experience.
        /// </summary>
        /// <param name="package">App's package name</param>
